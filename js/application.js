(function() {
  ...
  window.Application = function(params) {
    ...
    function show_content() {
      ...
      $('img').attr('src', 'http://' + app.savedata.plex_ip + ':' + app.savedata.plex_port + '/library/metadata/' + f.id + '/thumb').load(function() {
        $('.flex-container .container .loading').fadeOut();
      });
